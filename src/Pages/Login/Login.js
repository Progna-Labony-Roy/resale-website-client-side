...
const Login = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(handleLogin)}>
      ...
      <input type="submit" value='login' className="btn btn-success my-3 w-full" />
      <div>
        {
          <p className="text-red-500 py-1"></p>
        }
      </div>
      <p>New to doctors portal? <Link to='/signup' className="text-orange-500">Create an account</Link> </p>
